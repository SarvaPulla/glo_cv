    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.glo_cv"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.glo_cv.tests.tests"

        To run tests in the GloCvTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.glo_cv.tests.tests.GloCvTestCase"

        To run only the test_if_tethys_platform_is_great function in the GloCvTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.glo_cv.tests.tests.GloCvTestCase.test_if_tethys_platform_is_great"
...
class GloCvTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(GloCv)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(GloCv)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/glo-cv/')  # The final '/' is essential for all pages/controllers
